...
/////////////////
const BotName = 'RYUU BOT☄'; 
const instagram = 'https://instagram.com/raffaaa.id'; 
const telegram = 'https://t.me/raffaa'; 
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@raffaa346)
})
